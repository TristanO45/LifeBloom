    ...
    <section className="relative">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white z-10 space-y-3">
        ...
        <div className="pt-2 sm:pt-4 md:pt-6 lg:pt-8">
          <Link href="/contact">
            <button className="relative overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 py-1 sm:py-2 md:py-3 text-base sm:text-lg md:text-xl lg:text-2xl font-medium text-white bg-[#B1BCA0] border border-[#333a29] rounded-md shadow-inner group">
