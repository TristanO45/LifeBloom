  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white z-10 space-y-3">
        ...
        <p className="w-full sm:w-4/5 md:w-3/4 text-base sm:text-lg md:text-xl lg:text-xl mt-2 sm:mt-4 px-2">
        ...
        <div className="pt-2 sm:pt-4 md:pt-6 lg:pt-8">
          <Link href="/contact">
            <button className="relative overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 py-1 sm:py-2 md:py-3 text-lg sm:text-xl font-medium text-white bg-[#6a6e59]  rounded-md shadow-inner group">
