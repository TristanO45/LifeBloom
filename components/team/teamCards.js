...
function TeamCards() {
  return (
    <section className="bg-[#d5ae92] py-16 flex justify-center">
  <div className="container mx-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
    {teamCard.map((items, index) => {
      ...
      return (
        <div
          key={index}
          className="bg-white group py-4 px-8 flex flex-col rounded-sm overflow-hidden shadow-md max-w-[400px] mx-auto"
